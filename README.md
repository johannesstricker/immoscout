...
This is a sample template for immoscout - Below is a brief explanation of what we have generated for you:
...
```bash
sam logs -n HelloWorldFunction --stack-name immoscout --tail
```
...
```bash
aws cloudformation delete-stack --stack-name immoscout
```
